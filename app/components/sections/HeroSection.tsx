  ...
  return (
    <div>
      <div className='flex flex-col items-center justify-center custom-container'>
        <h1 className='text-[120px] text-[#F0F0F0] font-schibsted font-semibold text-center mb-10 leading-[87%] tracking-[-3%]'>
      ...
      <div className='relative flex flex-col w-full items-center bg-[url("/Group2147258273.png")] min-h-[500px] bg-cover bg-center justify-center overflow-hidden rounded-3xl'>
        <div className='relative z-10 flex w-full flex-col items-center justify-center gap-4 mb-15'>
          <InputActionRow
